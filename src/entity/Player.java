...
//		worldY = gp.tileSize * 38;
		...
		strength = 8; // More Strength = more damage default 2
		dexterity = 7; // More Dexterity = more defense default 1
		exp = 0;
		nextLevelExp = 5;
		coin = 500;
	...
	public void getImage() {
		...
		battleState = setUp("/Rythian/rythian_fight", gp.tileSize*2, gp.tileSize*3);
		selectScreen = setUp("/Rythian/rythian_down_1", gp.tileSize*2, gp.tileSize*2);
		dialogueImage = setUp("/testDialogue", gp.tileSize*4, gp.tileSize*4);
	}
	...
	public void update() {
		...
		if(gp.keyH.shotKeyPressed == true && projectile.alive == false &&
			...
			// SET DEFAULT CORRDINATES, DIRECTION AND USER
	...
	public void damageInteractiveTile(int i) {
		...
		} else if(i != 999 && gp.iTile[gp.currentMap][i].destructible == true &&
				gp.iTile[gp.currentMap][i].isCorrectLevel(this) == true && gp.iTile[gp.currentMap][i].invincible == false) {
