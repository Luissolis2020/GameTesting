...
import monster.MON_GreenSlimeBattle;
import monster.MON_Mimic;
...
import tile_interactive.IT_Level_Door;
...
public class AssetSetter {
	...
	public void setNPC() {
		...
		gp.npc[mapNum][i] = new Merchant_Flame(gp);
		...
		gp.npc[mapNum][i] = new NPC_IntroMerch(gp);
...
//		i++;
		...
		mapNum = 2;
		//Top
		gp.monster[mapNum][1] = new MON_GreenSlimeBattle(gp);
		gp.monster[mapNum][1].worldX = gp.tileSize*16;
		gp.monster[mapNum][1].worldY = gp.tileSize*5;
		//Middle
		gp.monster[mapNum][2] = new MON_GreenSlimeBattle(gp);
		gp.monster[mapNum][2].worldX = gp.tileSize*15;
		gp.monster[mapNum][2].worldY = (int)(gp.tileSize*7.4);
		//Bottom
		gp.monster[mapNum][3] = new MON_GreenSlimeBattle(gp);
		gp.monster[mapNum][3].worldX = gp.tileSize*16;
		gp.monster[mapNum][3].worldY = (int)(gp.tileSize*9.8);
		
		mapNum = 0;
		i = 0;
		gp.obj[mapNum][i] = new MON_Mimic(gp);
	...
	public void setInteractiveTile() {
		...
		mapNum = 0;
		i = 0;
		gp.iTile[mapNum][i] = new IT_Level_Door(gp, 22, 25, 2); 
		i++;
	}
}
